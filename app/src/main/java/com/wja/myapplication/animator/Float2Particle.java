...
public class Float2Particle extends Particle {
     ...
     */
    public Float2Particle(int orientation, Point point, int color, int radius, Rect rect, float endValue, Random random, float horizontalMultiple, float verticalMultiple){
