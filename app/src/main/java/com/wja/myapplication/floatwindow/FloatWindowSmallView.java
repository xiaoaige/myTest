...
public class FloatWindowSmallView extends LinearLayout {
    ...
    public FloatWindowSmallView(Context context) {
        ...
        mPercentView.setText(MyWindowManager.getUsedPercentValue(context));
        windowViewWidth = mPercentView.getLayoutParams().width;
        windowViewHeight = mPercentView.getLayoutParams().height;
    }
